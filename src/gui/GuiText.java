...
public class GuiText {
	...
	private static BufferedImage bulletLevel;
	private static BufferedImage untiShoot;
	private static BufferedImage score;
	...
	static {
		try {
			bulletLevel = ImageIO.read(GuiText.class.getResourceAsStream("/image/gui/bulletLevel.jpg"));
			untiShoot = ImageIO.read(GuiText.class.getResourceAsStream("/image/gui/rocket.png"));
			score = ImageIO.read(GuiText.class.getResourceAsStream("/image/gui/score.png"));
			sword = ImageIO.read(GuiText.class.getResourceAsStream("/image/gui/swordIcon.png"));
			boss = ImageIO.read(GuiText.class.getResourceAsStream("/image/gui/bossIcon.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void draw(Graphics g) {
		...
		g.drawImage(bulletLevel.getSubimage((bulletNum - 1) * 107, 0, 107, bulletLevel.getHeight()), 95, 645, 30, 35,
				null);
		...
		if (currentWave < 10)
			...
			g.drawImage(boss, 730, 5, 45, 40, null);
